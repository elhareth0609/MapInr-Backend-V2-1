...
Route::middleware(['bearer.token','auth:sanctum'])->group(function () {
  ...
  Route::post('/v1/reactions/destroy', [ReactionController::class, 'destroy'])->name('counter.destroy');
  Route::post('/v1/reactions/destroy-lot', [ReactionController::class, 'destroy_lot'])->name('counter.destroy.lot');
